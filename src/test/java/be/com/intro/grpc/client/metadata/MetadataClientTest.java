...
import be.com.intro.grpc.client.deadline.DeadlineInterceptor;
import br.com.intro.grpc.server.metadata.UserRole;
...
public class MetadataClientTest {
    ...
    public void balanceTest(){
        ...
        for (int i = 0; i < 20; i++) {
            ...
            String role = random == 2 ? "prime" : "standard";
            try{
                Balance balance = this.bankServiceBlockingStub
                        //.withDeadline(Deadline.after(2, TimeUnit.SECONDS))
                        .withCallCredentials(new UserSessionToken("user-secret-"+random+":"+role))
